...
2.  **SSL Certificates** generated by Let's Encrypt (Certbot) located at:
    *   `/etc/letsencrypt/live/makemydummytrip.com/fullchain.pem`
    *   `/etc/letsencrypt/live/makemydummytrip.com/privkey.pem`
